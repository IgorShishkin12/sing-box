...
func TestValidate_RNodeSerial_LoraFields(t *testing.T) {
	...
	cases := []struct {
		...
		{"txpower too high", func(i *option.ReticulumInterface) { i.TxPowerDBm = option.TxPow(38) }, true},
		{"txpower valid", func(i *option.ReticulumInterface) { i.TxPowerDBm = option.TxPow(17) }, false},
