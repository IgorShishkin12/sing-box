...
// setRustLogLevelIfUnset sets RUST_LOG before BridgeInit if it is not already
// set in the environment. Must be called before BridgeInit because Rust reads
// RUST_LOG exactly once during tracing subscriber initialization.
//
